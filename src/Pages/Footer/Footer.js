                ...
                <div className="row text-center">
                    ...
                    <div className="col-md-4 col-sm-12">
                        <div className="footer-info newsletter-form">
                            <div className="section-title">
                                <h2 className='text-center'>Newsletter Signup</h2>
                            </div>
                            <div>
                                <div className="form-group text-center">
                                    <form action="#" method="get">
                                        <input type="email" className="form-control text-center" placeholder="Enter your email" name="email" id="email" required="" />
                                        <input type="submit" className="form-control text-center m-auto" name="submit" id="form-submit" value="Send me" />
                                    </form>
